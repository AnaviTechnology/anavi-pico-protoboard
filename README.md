# ANAVI Pico Protoboard

ANAVI Pico Protoboard is a simple prototyping board for Raspberry Pi Pico. Based on a Raspberry Pi Pico footprint for KiCad by Nicolò Carandini:
